                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-4 bg-grey">
                                        <div class="p-5">
                                            ...
                                            @else
                                                <a
                                                    href="{{ route('front.googlelogin') }}?urldata={{ urlencode(route('front.checkout.checkout')) }}">

                                                    <button type="button" class="btn btn-dark btn-block btn-lg"
                                                        data-mdb-ripple-color="dark">Login to checkout</button>
                                                </a>
                                            @endif
                                        </div>
                                    </div>
    ...
    <script>
        ...
        const renderCart = () => {
            //selected option work is here //
            const cartItemsHtml = CART.products.map(product => {
                let selectedOptions = [];
                for (const [key, value] of Object.entries(product.other.options)) {
                    selectedOptions .push(`<strong>${key}:</strong> ${value} `);
                }
                ...
                <div class="col-md-3 col-lg-3 col-xl-3">
                    ...
                    <hr class="my-1">
                    <p class="text-muted"><strong>Selected Options:</strong><br> ${selectedOptions.join(',')}</p>
